...
class SiriProxy::Plugin::Example < SiriProxy::Plugin
  ...
  #restart siriproxy
  listen_for /kill siri proxy/i do
  	system 'bash ~/updatesiriproxy.sh'
    say "Siri Proxy Restarted!" #say something to the user!
    request_completed #always complete your request! Otherwise the phone will "spin" at the user!
  end
  
  listen_for /who is baobao/i do
    say "Kong Yang!" #say something to the user!
    
    request_completed #always complete your request! Otherwise the phone will "spin" at the user!
  end
  
  listen_for /i love you/i do
    say "i love you too, bo bo qi!" #say something to the user!
